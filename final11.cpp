...
class Department
{
	...
	////////////////////////////////////////////////////////////////////	
		...
		void AddEmployee(string deptname)
		{
			DepartmentName=deptname;
			int depsize;
		//	cout<<endl;
			
			cout<<"ENTER THE SIZE OF EMPLOYEEs:>";
			cin>>depsize;
			maxDepSize=depsize;
			TeacherInfo=new Teacher[maxDepSize];
	...
	////////////////////////////////////////////////////////////////////	 
	 	...
	 	int serchdeptbyname(string nam)
	 	{
	 		if(DepartmentName==nam)
			 return true;	
		}
	////////////////////////////////////////////////////////////////////	
...
class University
{
	string UniName, location, VCName, RegistrarName,deptname;
	Department *UniDepartments,*ptr,display;
	...
	public:
		...
		void AddDept(string name)
		{
			...
			{
				UniDepartments[l].AddEmployee(deptname);
				currUniSize++;
			}
		
			cout<<"DATa IS STORED :"<<endl;
		}
		void check(string nam)
		{
				cout<<"ENTER THE DEARTMENT NAME :> ";
				cin>>nam;
				for(int m=0;m<currUniSize;m++)
				{
						if(UniDepartments[m].serchdeptbyname(nam)==true)
						{
							UniDepartments[m].display();
						}
				}
...
int main()
{
	...
	switch(ch1)
	{
		...
		case '2':
		{
			...
			cout<<"  |   DISPLAY DATA           (PRESS - 7) |"<<endl;
			cout<<endl;
			cin>>ch4;
			Department object1;
			if(ch4=='1')
